        ...
        <Fragment>
            <Layout>
                ...
                <div className="rounded py-2 px-4 text-gray-900 bg-gray-100 shadow">
                    ...
                    <form onSubmit={updatePage} className="py-4" encType="multipart/form-data" autoComplete="off">

                        <div className="flex flex-wrap">
                            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-8/12">

                                <div className="pb-0">
                                    <label><span className="text-gray-500">Título da página</span></label>
                                    <input
                                        ref={titleRef}
                                        type="text"
                                ...
                                <div className="pt-2">
                                    <label><span className="text-gray-500">Resumo da Página</span></label>
                                    <textarea
                                        ref={summaryRef}
                            ...
                            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-4/12 p-8">
                                {
                                    imageFile
                                        ...
                                        <div className="border-4 border-gray-100 shadow-md rounded-md">
                                            <img src={page.featured ? '/storage/page/' + page.featured : '/storage/images/default.jpg'} />
                                        </div>
                                }
                            </div>
                        </div>
